import { View, Text, Button, TextInput, TouchableOpacity, StyleSheet, Alert, ActivityIndicator, KeyboardAvoidingView } from 'react-native'
        ...
        <View style={styles.formContainer}>
          ...
          <View>
            <TouchableOpacity
              ...
              style={email === '' || password === '' ? styles.buttondisable : styles.button}
              onPress={SignIn}
            >
              <Text style={email === '' || password === '' ? styles.buttonTextDisable : styles.buttonText}>Sign in</Text>
            </TouchableOpacity>
            ...
            >
              <Text style={email === '' || password === '' ? styles.buttonTextDisable : styles.buttonText}>Create Account</Text>
            </TouchableOpacity>
          </View>
        )}
        </View>
